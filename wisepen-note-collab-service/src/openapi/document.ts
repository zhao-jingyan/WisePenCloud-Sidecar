    ...
    schemas: {
      ...
      TextInline: {
        ...
        properties: {
          type: { const: 'text' },
          text: { type: 'string' },
          marks: { type: 'array', items: reference('PatchMark'), uniqueItems: true },
      ...
      InlineContent: {
        ...
        properties: {
          kind: { const: 'inline' },
          items: { type: 'array', items: reference('PatchInline') },
        },
      },
      TableContent: {
        type: 'object',
      ...
      InsertBlockCandidate: {
        ...
        properties: {
          ...
          content: reference('PatchContent'),
        },
      },
